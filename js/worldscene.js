class WorldScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON("map", "assets/trabp.json");
  ...
  create() {
    ...
    map.createStaticLayer("adereços", tileset, 0, 0);
    ...
    //adicionar o player
    player = this.physics.add.sprite(100, 450, "heroi");
    ...
    var platforms = map.createStaticLayer("Plataformas", tileset, 0, 0);
    ...
    var turbinaObjects = map.getObjectLayer("turbinas")["objects"];
    ...
    var bolaObjects = map.getObjectLayer("aguas")["objects"];
    var i = 0;
    ...
    var lavaObjects = map.getObjectLayer("aguas")["objects"];
